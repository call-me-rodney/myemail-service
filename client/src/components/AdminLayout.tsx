...
const AdminLayout: React.FC<AdminLayoutProps> = ({
  ...
  const menuItems = useMemo(
    () => [
      { key: 'emails' as const, label: 'Email Sending', icon: <CampaignIcon /> },
      { key: 'users' as const, label: 'User Management', icon: <GroupIcon /> },
      { key: 'templates' as const, label: 'Email Templates', icon: <DescriptionIcon /> },
      { key: 'lists' as const, label: 'Mailing Lists', icon: <ListAltIcon /> },
      { key: 'company' as const, label: 'Company Settings', icon: <BusinessIcon /> },
    ],
    [],
  );
